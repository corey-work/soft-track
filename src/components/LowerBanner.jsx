...
const LowerBanner = () => {
  return (
    <div className='w-full flex flex-col items-center justify-center relative p-3'>
      <img className='max-h-[17rem] brightness-50 w-full object-cover' src={banner} alt="" />
      <div className='absolute inset-0 flex flex-col justify-center items-start pl-18'>
