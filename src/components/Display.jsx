    ...
    <div className='w-full p-4 bg-slate-100'>
      <div className='max-w-[1450px] w-full mx-auto grid lg:grid-cols-2 place-items-center'>
        <div className='relative py-5'>
            <img className='max-w-[400px] h-[300px] object-cover bg-white w-full border border-gray-200 brightness-55 rounded-xl' src={img1} alt="" />
            <div className='absolute uppercase inset-0 text-center p-5 flex flex-col items-center justify-center'>
                ...
                <button className='px-4 py-3 mt-4 bg-blue-500 rounded-lg text-white  hover:bg-blue-800 transform duration-300 cursor-pointer'>Learn More</button>
            </div>
        </div>
