...
const Display = () => {
  return (
    <div className='w-full p-4 mt-6 bg-slate-100'>
      <div className='max-w-[1450px] w-full mx-auto grid lg:grid-cols-2 place-items-center'>
        ...
        <div className='relative uppercase'>
            ...
            <div className='absolute inset-0 text-center p-5 flex flex-col items-center justify-center'>
                ...
                <button className='px-4 py-3 mt-4 bg-blue-500 rounded-lg text-white  hover:bg-blue-600 transform duration-300 cursor-pointer'>Learn More &rarr;</button>
            </div>
        </div>
      </div>
    </div>
