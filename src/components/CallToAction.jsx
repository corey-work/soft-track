    ...
    <div className='w-full p-6 '>
      <div className='max-w-[1240px] mx-auto w-full flex items-center justify-center'>
            <div className='max-w-[600px]'>
                <h1 className='text-4xl py-3 font-bold text-blue-800 text-center'>Our Focus</h1>
            ...
            <div className='text-center max-h-[40rem] h-full p-3 border border-gray-300 bg-zinc-300 rounded-lg'>
                <h1 className='py-4 text-2xl font-bold text-blue-800'>Secure</h1>
            ...
            <div className='text-center max-h-[40rem] h-full p-3 border border-gray-300 bg-zinc-300 rounded-lg'>
            <h1 className='py-4 text-2xl font-bold text-blue-800'>Easy to Use</h1>
