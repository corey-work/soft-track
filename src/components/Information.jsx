  ...
  return (
    <div className='w-full px-2'>
      <div className='max-w-[1400px] mx-auto items-center justify-center grid lg:grid-cols-2 place-items-center'>
        ...
        <div className='py-2'>
          <h1 className='text-2xl py-1 lg:text-center text-start font-bold text-gray-800'>Design</h1>
        ...
        <div className='mt-4'>
          <h1 className='text-2xl py-1 md:text-center font-bold text-gray-800'>Manafacturing</h1>
          <p className='lg:text-xl text-lg font-medium text-black/60'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et aperiam ipsam eligendi. Id itaque laudantium temporibus rem repudiandae voluptas asperiores aspernatur quod obcaecati, facere aperiam incidunt vel autem tempora perferendis.</p>
        </div>
        <div className='mt-4'>
          <h1 className='text-2xl py-1 md:text-center font-bold text-gray-800'>Support</h1>
          <p className='lg:text-xl text-lg font-medium text-black/60'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et aperiam ipsam eligendi. Id itaque laudantium temporibus rem repudiandae voluptas asperiores aspernatur quod obcaecati, facere aperiam incidunt vel autem tempora perferendis.</p>
        </div>
        </div>
      </div>
