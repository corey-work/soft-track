  ...
  return (
    <div className='w-full p-4 bg-black'>
      ...
      <div className='max-w-[1240px] w-full mx-auto grid lg:grid-cols-3 place-items-center gap-3'>
        <div>
            <img loading='lazy' className='hover:brightness-50 transition-all ease-in-out duration-300 cursor-pointer' src={img1} alt="" />
        ...
        <div>
            <img loading='lazy' className='hover:brightness-50 transition-all ease-in-out duration-300 cursor-pointer' src={img2} alt="" />
        ...
        <div>
            <img loading='lazy' className='hover:brightness-50 transition-all ease-in-out duration-300 cursor-pointer' src={img3} alt="" />
